                    ...
                    <div className="flex flex-col flex-1 gap-3 text-baseTextHighEmphasis">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="flex flex-col relative">
                                <input step="0.01" placeholder="0" className="h-12 rounded-lg border-2 border-solid border-baseBorderLight bg-[var(--background)] pr-12 text-right text-2xl leading-9 text-[$text] placeholder-baseTextMedEmphasis ring-0 transition focus:border-accentBlue focus:ring-0" onChange={e => setAmount(e.target.value)} type="text" value={amount} />
